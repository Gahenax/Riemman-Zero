...
def build_plan():
    ...
    plan = {
        ...
        "variables": {
            ...
            "riemann_blocks": {
                "blocks": [{"name": "block_1000_1370", "n_start": 1000, "n_end": 1370}],
            ...
            "primary": [
                {
                    ...
                    "expected": {"poisson": 0.386, "goe": 0.536, "gue_or_cue": 0.60},
                }
            ],
            "secondary": [
                {
        ...
        "tasks": [
            {
                ...
                "outputs": {"report_path": "results/riemann_stats.json"},
                "checks": ["report.r_mean >= 0.57", "report.ks_gue <= 0.12"],
            },
            {
                ...
                "outputs": {"grid_path": "results/cronos_grid_stats.jsonl"},
                "checks": [
            ...
            },
            {
                ...
                "outputs": {"alignment_path": "results/alignment_report.json"},
                "checks": ["alignment.lowW_closer_than_highW == true"],
            },
            {
