...
def test_band_worker(probe: str, start_p: int, end_p: int, band_id: int, out_dir: str):
    ...
    # Simulate warmup for the massive 100M tier bounds
    accel = sim.activate_accelerator(start_p)
    append_event("ACCELERATOR_WARMUP", accel)

    time.sleep(1.5) # Virtual computation time for wave generation
    ...
    # Randomly sample a candidate to test thoroughly within this band
    sample_candidate = start_p + 37 
    ...
    append_event("HEALTH", {
         ...
         "duration_simulated_seconds": 14400.0 * 10
    })
...
class MersenneDominoOrchestrator:
    ...
    def run_sweep(self):
        print("==================================================")
        print(" GAHENAX MERSENNE DOMINO WAVE DEPLOYMENT")
        print("==================================================")
