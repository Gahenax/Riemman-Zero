...
def run_test(dim, seed=1000):
    ...
    iter_max = 300
    cfg = HardeningConfig(
        tau_growth=1.5, stagnation_window=50, stagnation_tol=1e-3, eps_norm=1e-18
    )
    seed_scores = {}
...
def main():
    ...
    print("=" * 110)
    print(
        f"{'DIM':>4}   {'Seed':>6}   {'Status':>12}   {'FailMode':>18}   {'StartNorm':>12}   {'EndNorm':>12}   {'UA':>6}   {'Rst':>4}   {'Clp':>4}"
    )
    print("-" * 110)
    ...
    for dim in dims:
        for seed in seeds:
            ...
            print(
                f"{dim:4}   {seed:6}   {status:>12}   {fail_mode:>18}   {start:12.1f}   {end:12.1f}   {spent:6.0f}   {resets:4}   {clamps:4}   Prog: {progress}"
            )
