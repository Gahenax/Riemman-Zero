...
def main():
    ...
    # Files to check
    jsonl_files = [
        "zeros_final_mining.jsonl",
        "drill_final_coverage.jsonl",
        "zeros_tripwire.jsonl",
    ]
...
"""
    ...
    print("  - ALL_ZEROS_FINAL.json created.")
    print("  - cronos_report.json exported.")
    print("  - final_verdict.md generated.")
